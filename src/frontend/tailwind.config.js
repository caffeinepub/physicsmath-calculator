  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        plasma: "0 0 20px oklch(var(--plasma) / 0.3), 0 0 60px oklch(var(--plasma) / 0.1)",
        "plasma-sm": "0 0 12px oklch(var(--plasma) / 0.25)",
      ...
      keyframes: {
        ...
        drift: {
          ...
          "66%": { transform: "translateY(10px) translateX(-15px) scale(0.9)", opacity: "0.3" },
        },
        "pulse-ring": {
